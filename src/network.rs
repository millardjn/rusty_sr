...
pub fn sr_net(factor: usize, training: bool, regularisation: f32) -> Graph {
	...
	for _ in 0..1 { // can have multiple independant chains
		...
		ops.push(Convolution::new(&f_activ, &l1_conv, &[5, 5], Padding::Same, "conv1", Convolution::init_msra(1.0)));
		ops.push(Convolution::new(&f_activ, &l2_conv, &[5, 5], Padding::Same, "conv2", Convolution::init_msra(1.0)));
		ops.push(Convolution::new(&f_activ, &l3_conv, &[5, 5], Padding::Same, "conv3", Convolution::init_msra(1.0)));
		...
		ops.push(Convolution::new(&l1_activ, &l2_conv, &[3, 3], Padding::Same, "conv5", Convolution::init_msra(1.0)));
		ops.push(Convolution::new(&l1_activ, &l3_conv, &[3, 3], Padding::Same, "conv6", Convolution::init_msra(1.0)));
		ops.push(Convolution::new(&l1_activ, &expand, &[3, 3], Padding::Same, "conv7", Convolution::init_msra(0.1)));

		ops.push(Convolution::new(&l2_activ, &l3_conv, &[3, 3], Padding::Same, "conv8", Convolution::init_msra(1.0)));
